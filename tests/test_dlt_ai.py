...
class DltAiTests(unittest.TestCase):
    ...
    def test_initialize_agent_runs_dlt_ai_init_for_selected_agent(self, run_uv_command: MagicMock) -> None:
    ...
    @patch("create_dlthub_workspace.dlt_ai.run_uv_command")
    def test_install_toolkit_runs_dlt_ai_toolkit_install(self, run_uv_command: MagicMock) -> None:
        project_dir = Path("/tmp/workspace")
